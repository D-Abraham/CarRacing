...
public class RGTrack extends JPanel {
	...
	// Written by Vrej.
	// Returns true if the both of the objects are a RGTrack object with the same
	// values.
	public boolean equals(Object obj) {
		if (obj == this)
			return true; // Make sure it's not this object.
		if (obj == null)
			return false; // Make sure the given object isn't null.
		if (obj.getClass() == this.getClass()) { // If both are the same class.
			...
			return (other.getTrackSize() == this.getTrackSize() && other.getCarSize() == this.getCarSize()); // Return
																												// true
																												// if
																												// all
																												// these
